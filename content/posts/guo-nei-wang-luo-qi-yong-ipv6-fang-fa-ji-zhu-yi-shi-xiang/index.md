...
tags = ["IPv6", "网络", "DNS"]
+++
> 旧文归档：本文写于 2019 年，适合作为当时个人折腾 IPv6 的记录。现在国内运营商和云厂商的 IPv6 支持已经变化，文中的免费隧道方案不应再当作首选生产方案，实际启用前请优先查看运营商、云厂商或系统当前文档。
...
此开启方法为IPv6中间技术之一的IPv6隧道技术。由于当时免费方法有限，笔者曾推荐使用此免费方法；现在阅读时更适合把它当成旧方案参考。
