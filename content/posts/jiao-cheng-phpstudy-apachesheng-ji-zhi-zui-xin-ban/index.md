...
用过phpStudy的同学应该知道，phpStudy的apache版本是2.4.23 (Win32)的，这个版本还是2016年的，很明显，已经很低了，而且还是32位的版本。 [![](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/cover.avif)](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/cover.avif) 当paniy我看到这个的时候，我是很不爽的，强迫症的我决定升级！ 我在网上找了很多关于phpStudy升级apache的办法，结果要么就是互相抄抄文章，要么就是不知所云的胡扯，我也奉劝大家一句，这个千万不要相信。不仅没啥用，而且有可能搞坏你的网站。 
...
首先你要做的，是卸载原来的apache。如果你是以系统服务运行的话，你首先要删除服务。 在cmd命令行中，输入[code]sc delete apache[/code]。 [![](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/04.avif)](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/04.avif) 然后进入apache/bin目录运行命令行，（你可以输入cd ...PHPTutorialApachebin），在此目录下输入[code]httpd.exe -k install -n apache[/code]，当你一切运行正常的话，你会发现有一个如图错误 [![](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/05.avif)](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/08.avif) apache无法运行！这是为什么？仔细研究错误报告，喔！原来Apachemodulesmod_fcgid.so这个文件不存在，那么直接去原来的apache文件夹中复制过来？错！绝对不可以这么做，我们现在回到之前下载apache的网站，往下翻，你会发现这个： [![](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/06.avif)](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/06.avif) 是的，你还需要下载这个！这就是为什么我说准备工作只是“基本”完成，其实压根还没完成。下载你需要的mod_fcgid.so版本，放入Apachemodules目录中，运行[code]sc delete apache[/code]命令后，再次运行[code]httpd.exe -k install -n apache[/code]，之后你就会看到这些反馈 [![](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/07.avif)](/images/posts/jiao-cheng-phpstudy-apachesheng-ji-zhi-zui-xin-ban/07.avif) 注意最后一句话：Errors reported here must be corrected before the service can be started.难道这意味着还有问题，不不不，如果下面没有东西，恭喜你！你升级完毕！ 
