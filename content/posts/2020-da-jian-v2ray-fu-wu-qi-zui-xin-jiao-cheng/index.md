+++
title = "2020 搭建 V2Ray 服务器最新教程"
date = 2019-10-05T01:05:00+08:00
draft = true
...
featureimage = "https://cdn.idleleo.com/wp-content/uploads/2019/05/20190519202007-1024x510.jpg"
+++
...
![](/images/wp-content/uploads/2019/05/20190519202007-1024x510.jpg)
...
GitHub地址：[链接](<https://github.com/Jrohy/multi-v2ray>)
...
![](/images/wp-content/uploads/2019/05/20190519203446.jpg)
...
GitHub地址：[链接](<https://github.com/paniy/V2Ray_ws-tls_bash_onekey>)（优化版）、[链接](<https://github.com/wulabing/V2Ray_ws-tls_bash_onekey>)（原版）

**现有最新基于Xray的脚本，看这里** ：[2020 搭建 Xray 服务器最新教程](<https://hey.run/posts/2023-da-jian-xray-fu-wu-qi-zui-xin-jiao-cheng>)

此为基于 Nginx 的 vless+ws+tls 一键安装脚本 （Use Path）。部署速度快，但相较之multi-v2ray缺少了定制以及用户组等功能。增加不同的配置需要手动更改配置文件。因此适合自用。
...
A：这个问题是笔者的疏忽 :cry: ，新版本已经解决了这个问题。无法更新的小伙伴可以先运行命令`rm -f /usr/bin/idleleo`，再重新运行下首次安装命令（上面的）即可。

Q：V2ray-core升级后为什么没法使用？

A：最新V2ray升级后导致证书权限不足，现已经在新版本中修复（修复的本质是开倒车hh）。熟悉配置的小伙伴可以自行参考官方给出的解决办法：[链接](<https://github.com/v2fly/fhs-install-v2ray/wiki/Insufficient-permissions-when-using-certificates>)
...
### [](<https://github.com/wulabing/V2Ray_ws-tls_bash_onekey#%E5%90%AF%E5%8A%A8%E6%96%B9%E5%BC%8F>)启动方式
...
![](/images/wp-content/uploads/2019/06/20190606204659-1024x282.jpg)

### 相关注意

经笔者实际测试，脚本由于均仍在维护，因此bug较少。但也不排除存在bug。如第一个脚本，经笔者测试时发现存在bug致使部署失败。经联系原作者后才妥善解决。因此，若出现问题，请及时关注社区信息。

在实际部署中，~~对于CentOS 7等系统的用户可能需要注意开启相应的端口，如`80`、`443`，前者部署SSL证书需要使用，后者若V2Ray为ws+tls协议时可能需要开启。~~**现脚本已自带。**
...
![](/images/wp-content/uploads/2020/11/202011031719-1024x547.jpg)
...
项目链接：[链接](<https://github.com/proxysu/windows>)

使用教程：[一键搭建科学上网工具ProxySU](<https://github.com/Alvin9999/new-pac/wiki/%E4%B8%80%E9%94%AE%E6%90%AD%E5%BB%BA%E7%A7%91%E5%AD%A6%E4%B8%8A%E7%BD%91%E5%B7%A5%E5%85%B7ProxySU>)
...
搭建 Xray 最新教程：[2020 搭建 Xray 服务器最新教程](<https://hey.run/posts/2023-da-jian-xray-fu-wu-qi-zui-xin-jiao-cheng>)
...
V2Ray各平台客户端：[V2Ray 客户端下载](<https://www.idleleo.com/02/988.html>)
